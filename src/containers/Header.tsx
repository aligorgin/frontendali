	...
	return (
		...
		>
			...
			<div className="flex flex-col items-center justify-center pt-8 sm:flex-row sm:justify-start">
				<button
					className={clsx(
						'flex h-[48px] w-[280px] items-center justify-center rounded-md text-white shadow-lg shadow-black/20 transition-all duration-200 active:scale-95 dark:shadow-white/10 sm:h-[40px] sm:w-[170px] sm:hover:-translate-y-[2px] sm:active:translate-y-0',
